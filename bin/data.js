...
module.exports = [{
    ...
    description: "A Associação Portuguesa de Apoio à Vítima (APAV) é uma instituição particular de solidariedade social, pessoa colectiva de utilidade pública, que tem como objectivo estatutário promover e contribuir para a informação, protecção e apoio aos cidadãos vítimas de infracções penais.",
  ...
  },
  {
    ...
    language: "French", //not required
    description: "Le Collectif National pour les Droits des Femmes est un regroupement d’associations féministes, de syndicats et partis politiques constitué le 24 janvier 1996.", //required
    url: "",
    geometry: {
  ...
  },
  {
    ...
    language: "English", //not required
    description: "The Center for Reproductive Rights is a global human rights organization of lawyers and advocates who ensure reproductive rights are protected in law as fundamental human rights for the dignity, equality, health, and well-being of every person.", //required
  ...
  },
  {
    ...
    language: "English", //not required
    description: "We are committed to upholding the rights described by the Universal Declaration of Human Rights—from civil and political rights, such as the right to free assembly and freedom of speech, to economic and social rights, such as the right to education, food, and housing. The promotion of human rights informs all our work—and has helped shape our response to the COVID-19 pandemic. Our Human Rights Initiative focuses in particular on challenging impunity and ensuring accountability, tackling discrimination and abusive practices in law enforcement and criminal justice, and defending freedoms of expression, assembly, and association.", //required
