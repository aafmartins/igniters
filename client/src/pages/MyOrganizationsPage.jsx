...
export default function MyOrganizationsPage() {
    ...
    return (
        <div>
            {savedClicked ? 
            (<div>
                <button  disabled>My Saved Organizations</button><button onClick={handleClick} >My Created Organizations</button>
                    <MySavedOrganizations/>
                </div>)
            : 
            (<div>
                <button onClick={handleClick} >My Saved Organizations</button><button disabled >My Created Organizations</button>
